...
//=============================================================================
import { GggDataStructures } from "./GggDataStructures"
import { GggCore } from "./GggCore"
let gggDataStructures = new GggDataStructures();
...
var functionDeclarationsFun = function () {
    type NameAndAgeContainer = { a: string, b?: number }
    function f({ a, b }: NameAndAgeContainer): void {
        console.log("a", a);
        console.log("b", b);
    }
    f({
...
var sampleMatrixFun = function () {
    let sampleMatrix = GggDataStructures.CreateMatrix(5, 5, 5);
...
var printRandomArray = function () {
    let randomArray: Array<number> = GggDataStructures.GetRandomIntArray(5, 0, 10);
...
var printRandomTuple = function () {
    var randomTuple = GggDataStructures.GetRandomIntTuple(10, 100);
    GggCore.Log(randomTuple);
}
// printRandomTuple();
//=============================================================================
var printRandomMixedArray = function () {
    var randomMixedArray = GggDataStructures.GetRandomMixedArray(10);
    GggCore.Log(randomMixedArray);
}
